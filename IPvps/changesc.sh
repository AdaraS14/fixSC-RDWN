...
case "$x" in 
   ...
   apt update && apt upgrade -y && wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/IPvps/setup.sh && chmod +x setup.sh && ./setup.sh
   ;;
   4 | 04)
   clear
   apt update && apt upgrade -y && wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/xray/install.sh && chmod +x install.sh && ./install.sh
   ;;
   *)
   xdrg
esac
