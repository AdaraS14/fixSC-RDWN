...
Exp=$(curl -sS https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/IPvps/ip | grep $MYIP | awk '{print $3}')
fi
...
exp=$( curl -s https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/IPvps/ip | grep -w $IP | cut -d ' ' -f 3 )
