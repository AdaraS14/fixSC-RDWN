...
###
BURIQ () {
    curl -sS https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/IPvps/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/IPvps/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/IPvps/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo ""
wget -q https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/SCrdwn/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/SCrdwn/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/SCrdwn/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/SCrdwn/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/SCrdwn/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/SCrdwn/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/AdaraS14/fixSC-RDWN/main/SCrdwn/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
